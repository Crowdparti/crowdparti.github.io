...
gl_PointSize =(u_par_size[i]/gl_Position.w)+2.0;
...
`)
              ...
              fin.timers.start(function () {
                  ...
                  /*
                  document.title = ix.toFixed(3) + ',' + iy.toFixed(3) + ',' + iz.toFixed(3);

                  points.clear();
                  points.add(ix, iy, iz, 1, 0, 0, 10);

                  lines.clear();

                  lines.add2(-2.6, -1.7, 5.25, -1.8, -1.85, 5.55);
                  */
              }, 0.01);
